# Comparing `tmp/leaf_BasedLabs-0.0.6.tar.gz` & `tmp/leaf_BasedLabs-0.0.7.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "leaf_BasedLabs-0.0.6.tar", last modified: Mon Mar 25 19:55:00 2024, max compression
+gzip compressed data, was "leaf_BasedLabs-0.0.7.tar", last modified: Wed Apr  3 22:16:16 2024, max compression
```

## Comparing `leaf_BasedLabs-0.0.6.tar` & `leaf_BasedLabs-0.0.7.tar`

### file list

```diff
@@ -1,20 +1,20 @@
-drwxrwxrwx   0        0        0        0 2024-03-25 19:55:00.741436 leaf_BasedLabs-0.0.6/
--rw-rw-rw-   0        0        0    11558 2024-03-23 19:52:24.000000 leaf_BasedLabs-0.0.6/LICENSE
--rw-rw-rw-   0        0        0     2054 2024-03-25 19:55:00.741436 leaf_BasedLabs-0.0.6/PKG-INFO
--rw-rw-rw-   0        0        0     1495 2024-03-23 19:56:52.000000 leaf_BasedLabs-0.0.6/README.md
--rw-rw-rw-   0        0        0      543 2024-03-25 19:54:35.000000 leaf_BasedLabs-0.0.6/pyproject.toml
--rw-rw-rw-   0        0        0       42 2024-03-25 19:55:00.741436 leaf_BasedLabs-0.0.6/setup.cfg
-drwxrwxrwx   0        0        0        0 2024-03-25 19:55:00.735438 leaf_BasedLabs-0.0.6/src/
--rw-rw-rw-   0        0        0        0 2024-03-23 20:24:46.000000 leaf_BasedLabs-0.0.6/src/__init__.py
--rw-rw-rw-   0        0        0     1374 2024-03-23 20:37:09.000000 leaf_BasedLabs-0.0.6/src/example.py
-drwxrwxrwx   0        0        0        0 2024-03-25 19:55:00.737436 leaf_BasedLabs-0.0.6/src/leaf/
--rw-rw-rw-   0        0        0       63 2024-03-23 19:48:04.000000 leaf_BasedLabs-0.0.6/src/leaf/__init__.py
--rw-rw-rw-   0        0        0      493 2024-03-16 20:56:34.000000 leaf_BasedLabs-0.0.6/src/leaf/exception.py
--rw-rw-rw-   0        0        0     9562 2024-03-25 19:54:16.000000 leaf_BasedLabs-0.0.6/src/leaf/filesystem.py
-drwxrwxrwx   0        0        0        0 2024-03-25 19:55:00.740437 leaf_BasedLabs-0.0.6/src/leaf_BasedLabs.egg-info/
--rw-rw-rw-   0        0        0     2054 2024-03-25 19:55:00.000000 leaf_BasedLabs-0.0.6/src/leaf_BasedLabs.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      316 2024-03-25 19:55:00.000000 leaf_BasedLabs-0.0.6/src/leaf_BasedLabs.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-03-25 19:55:00.000000 leaf_BasedLabs-0.0.6/src/leaf_BasedLabs.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       28 2024-03-25 19:55:00.000000 leaf_BasedLabs-0.0.6/src/leaf_BasedLabs.egg-info/top_level.txt
-drwxrwxrwx   0        0        0        0 2024-03-25 19:55:00.740437 leaf_BasedLabs-0.0.6/src/tests/
--rw-rw-rw-   0        0        0     3740 2024-03-17 13:17:08.000000 leaf_BasedLabs-0.0.6/src/tests/tests.py
...
### Comparing `leaf_BasedLabs-0.0.6/LICENSE` & `leaf_BasedLabs-0.0.7/LICENSE`
...
### Comparing `leaf_BasedLabs-0.0.6/PKG-INFO` & `leaf_BasedLabs-0.0.7/PKG-INFO`
...
### Comparing `leaf_BasedLabs-0.0.6/README.md` & `leaf_BasedLabs-0.0.7/README.md`
...
### Comparing `leaf_BasedLabs-0.0.6/src/example.py` & `leaf_BasedLabs-0.0.7/src/example.py`
...
### Comparing `leaf_BasedLabs-0.0.6/src/leaf_BasedLabs.egg-info/PKG-INFO` & `leaf_BasedLabs-0.0.7/src/leaf_BasedLabs.egg-info/PKG-INFO`
