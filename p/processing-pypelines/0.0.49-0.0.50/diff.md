# Comparing `tmp/processing-pypelines-0.0.49.tar.gz` & `tmp/processing-pypelines-0.0.50.tar.gz`
...
### Comparing `processing-pypelines-0.0.49/pyproject.toml` & `processing-pypelines-0.0.50/pyproject.toml`
