# Comparing `tmp/mo-json-config-4.579.24081.tar.gz` & `tmp/mo-json-config-4.582.24095.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "mo-json-config-4.579.24081.tar", last modified: Thu Mar 21 02:41:15 2024, max compression
+gzip compressed data, was "mo-json-config-4.582.24095.tar", last modified: Thu Apr  4 04:09:49 2024, max compression
```

## Comparing `mo-json-config-4.579.24081.tar` & `mo-json-config-4.582.24095.tar`

### file list

```diff
@@ -1,17 +1,17 @@
-drwxrwxrwx   0        0        0        0 2024-03-21 02:41:15.983175 mo-json-config-4.579.24081/
--rw-rw-rw-   0        0        0    16725 2019-11-12 21:32:58.000000 mo-json-config-4.579.24081/LICENSE.txt
--rw-rw-rw-   0        0        0    11685 2024-03-21 02:41:15.982066 mo-json-config-4.579.24081/PKG-INFO
--rw-rw-rw-   0        0        0     9939 2024-03-08 02:34:29.000000 mo-json-config-4.579.24081/README.md
-drwxrwxrwx   0        0        0        0 2024-03-21 02:41:15.954706 mo-json-config-4.579.24081/mo_json_config/
--rw-rw-rw-   0        0        0    11234 2024-03-10 19:25:57.000000 mo-json-config-4.579.24081/mo_json_config/__init__.py
--rw-rw-rw-   0        0        0     2411 2023-04-29 14:14:40.000000 mo-json-config-4.579.24081/mo_json_config/configuration.py
--rw-rw-rw-   0        0        0      697 2023-06-02 01:48:46.000000 mo-json-config-4.579.24081/mo_json_config/convert.py
--rw-rw-rw-   0        0        0     3113 2024-03-08 02:34:29.000000 mo-json-config-4.579.24081/mo_json_config/ssm.py
-drwxrwxrwx   0        0        0        0 2024-03-21 02:41:15.981036 mo-json-config-4.579.24081/mo_json_config.egg-info/
--rw-rw-rw-   0        0        0    11685 2024-03-21 02:41:15.000000 mo-json-config-4.579.24081/mo_json_config.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      326 2024-03-21 02:41:15.000000 mo-json-config-4.579.24081/mo_json_config.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-03-21 02:41:15.000000 mo-json-config-4.579.24081/mo_json_config.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0      207 2024-03-21 02:41:15.000000 mo-json-config-4.579.24081/mo_json_config.egg-info/requires.txt
--rw-rw-rw-   0        0        0       15 2024-03-21 02:41:15.000000 mo-json-config-4.579.24081/mo_json_config.egg-info/top_level.txt
--rw-rw-rw-   0        0        0       42 2024-03-21 02:41:15.983175 mo-json-config-4.579.24081/setup.cfg
--rw-rw-rw-   0        0        0    11541 2024-03-21 02:41:10.000000 mo-json-config-4.579.24081/setup.py
+drwxrwxrwx   0        0        0        0 2024-04-04 04:09:49.190154 mo-json-config-4.582.24095/
+-rw-rw-rw-   0        0        0    16725 2019-11-12 21:32:58.000000 mo-json-config-4.582.24095/LICENSE.txt
+-rw-rw-rw-   0        0        0    11685 2024-04-04 04:09:49.190154 mo-json-config-4.582.24095/PKG-INFO
+-rw-rw-rw-   0        0        0     9939 2024-03-08 02:34:29.000000 mo-json-config-4.582.24095/README.md
+drwxrwxrwx   0        0        0        0 2024-04-04 04:09:49.165677 mo-json-config-4.582.24095/mo_json_config/
+-rw-rw-rw-   0        0        0    11234 2024-03-10 19:25:57.000000 mo-json-config-4.582.24095/mo_json_config/__init__.py
+-rw-rw-rw-   0        0        0     2411 2023-04-29 14:14:40.000000 mo-json-config-4.582.24095/mo_json_config/configuration.py
+-rw-rw-rw-   0        0        0      697 2023-06-02 01:48:46.000000 mo-json-config-4.582.24095/mo_json_config/convert.py
+-rw-rw-rw-   0        0        0     3113 2024-03-08 02:34:29.000000 mo-json-config-4.582.24095/mo_json_config/ssm.py
+drwxrwxrwx   0        0        0        0 2024-04-04 04:09:49.185758 mo-json-config-4.582.24095/mo_json_config.egg-info/
+-rw-rw-rw-   0        0        0    11685 2024-04-04 04:09:49.000000 mo-json-config-4.582.24095/mo_json_config.egg-info/PKG-INFO
+-rw-rw-rw-   0        0        0      326 2024-04-04 04:09:49.000000 mo-json-config-4.582.24095/mo_json_config.egg-info/SOURCES.txt
+-rw-rw-rw-   0        0        0        1 2024-04-04 04:09:49.000000 mo-json-config-4.582.24095/mo_json_config.egg-info/dependency_links.txt
+-rw-rw-rw-   0        0        0      207 2024-04-04 04:09:49.000000 mo-json-config-4.582.24095/mo_json_config.egg-info/requires.txt
+-rw-rw-rw-   0        0        0       15 2024-04-04 04:09:49.000000 mo-json-config-4.582.24095/mo_json_config.egg-info/top_level.txt
+-rw-rw-rw-   0        0        0       42 2024-04-04 04:09:49.190154 mo-json-config-4.582.24095/setup.cfg
+-rw-rw-rw-   0        0        0    11541 2024-04-04 04:09:43.000000 mo-json-config-4.582.24095/setup.py
```

### Comparing `mo-json-config-4.579.24081/LICENSE.txt` & `mo-json-config-4.582.24095/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `mo-json-config-4.579.24081/PKG-INFO` & `mo-json-config-4.582.24095/PKG-INFO`
...
+Requires-Dist: mo-logs==8.582.24095
 ...
 Requires-Dist: keyring>=24.3.1; extra == "tests"
 Requires-Dist: boto3>=1.34.67; extra == "tests"
 Requires-Dist: pyyaml; extra == "tests"
 Requires-Dist: moto>=4.2.14; extra == "tests"
```

### Comparing `mo-json-config-4.579.24081/README.md` & `mo-json-config-4.582.24095/README.md`

 * *Files identical despite different names*

### Comparing `mo-json-config-4.579.24081/mo_json_config/__init__.py` & `mo-json-config-4.582.24095/mo_json_config/__init__.py`

 * *Files identical despite different names*

### Comparing `mo-json-config-4.579.24081/mo_json_config/configuration.py` & `mo-json-config-4.582.24095/mo_json_config/configuration.py`

 * *Files identical despite different names*

### Comparing `mo-json-config-4.579.24081/mo_json_config/convert.py` & `mo-json-config-4.582.24095/mo_json_config/convert.py`

 * *Files identical despite different names*

### Comparing `mo-json-config-4.579.24081/mo_json_config/ssm.py` & `mo-json-config-4.582.24095/mo_json_config/ssm.py`

 * *Files identical despite different names*

### Comparing `mo-json-config-4.579.24081/mo_json_config.egg-info/PKG-INFO` & `mo-json-config-4.582.24095/mo_json_config.egg-info/PKG-INFO`
...
### Comparing `mo-json-config-4.579.24081/setup.py` & `mo-json-config-4.582.24095/setup.py`
...
@@ -3,16 +3,16 @@
 ...
 setup(
     ...
     extras_require={"tests":["mo-testing>=7.562.24075","keyring>=24.3.1","boto3>=1.34.67","pyyaml","moto>=4.2.14"]},
-    install_requires=["hjson","mo-dots==9.578.24081","mo-files==6.579.24081","mo-future==7.546.24057","mo-json==6.579.24081","mo-logs==8.579.24081","requests"],
+    install_requires=["hjson","mo-dots==9.582.24095","mo-files==6.582.24095","mo-future==7.546.24057","mo-json==6.582.24095","mo-logs==8.582.24095","requests"],
     license='MPL 2.0',
