# Comparing `tmp/mimic_replay-1.1.0.tar.gz` & `tmp/mimic_replay-1.1.1.tar.gz`
...
## Comparing `mimic_replay-1.1.0.tar` & `mimic_replay-1.1.1.tar`
...
### Comparing `mimic_replay-1.1.0/LICENSE` & `mimic_replay-1.1.1/LICENSE`

 * *Files identical despite different names*

### Comparing `mimic_replay-1.1.0/PKG-INFO` & `mimic_replay-1.1.1/PKG-INFO`
...
### Comparing `mimic_replay-1.1.0/pyproject.toml` & `mimic_replay-1.1.1/pyproject.toml`
...
### Comparing `mimic_replay-1.1.0/src/mimic_replay/config.py` & `mimic_replay-1.1.1/src/mimic_replay/config.py`

 * *Files identical despite different names*

### Comparing `mimic_replay-1.1.0/src/mimic_replay/injector.py` & `mimic_replay-1.1.1/src/mimic_replay/injector.py`

 * *Files identical despite different names*

### Comparing `mimic_replay-1.1.0/src/mimic_replay/install.py` & `mimic_replay-1.1.1/src/mimic_replay/install.py`
...
### Comparing `mimic_replay-1.1.0/src/mimic_replay.egg-info/PKG-INFO` & `mimic_replay-1.1.1/src/mimic_replay.egg-info/PKG-INFO`
