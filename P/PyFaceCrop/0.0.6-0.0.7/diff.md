# Comparing `tmp/PyFaceCrop-0.0.6.tar.gz` & `tmp/PyFaceCrop-0.0.7.tar.gz`
...
## Comparing `PyFaceCrop-0.0.6.tar` & `PyFaceCrop-0.0.7.tar`
...
### Comparing `PyFaceCrop-0.0.6/LICENSE` & `PyFaceCrop-0.0.7/LICENSE`

 * *Files identical despite different names*

### Comparing `PyFaceCrop-0.0.6/PKG-INFO` & `PyFaceCrop-0.0.7/PKG-INFO`
...
### Comparing `PyFaceCrop-0.0.6/PyFaceCrop/FaceCrop.py` & `PyFaceCrop-0.0.7/PyFaceCrop/FaceCrop.py`

 * *Files identical despite different names*

### Comparing `PyFaceCrop-0.0.6/PyFaceCrop.egg-info/PKG-INFO` & `PyFaceCrop-0.0.7/PyFaceCrop.egg-info/PKG-INFO`
...
### Comparing `PyFaceCrop-0.0.6/README.md` & `PyFaceCrop-0.0.7/README.md`
